...
async function testRender() {
	 ...
	 * 2. **Model-as-Schema / Model-as-App**: Опис даних, валідація та поведінка єдині в JS-моделях.
	 * 3. **Data-Driven Applications**: Усі екрани, макети та сторінки відмальовуються з роутерифікацій та моделей, збережених у будь-якій агностичній базі даних через протокол `db.fetch()`.
