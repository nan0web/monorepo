...
# Release v1.2.0 (Model-as-Schema v2 & @nan0web/types Integration)

## Scope

Migration of `nan0web.app` domain models to the `Model` base class from `@nan0web/types` (Golden Standard v2).
...
1. `@nan0web/types` added as `workspace:*` dependency.
