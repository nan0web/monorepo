...
import DB, { DBDriverProtocol, HydratedModel } from '../../../../../index.js'

describe('Release v3.4.0: HydratedModel & Caching in @nan0web/db', () => {
	...
	describe('4. Performance Benchmark', () => {
		it('4.1 1000 documents with globals, inherit and refs execute in < 500ms', async () => {
			...
			assert.ok(
				durationMs < 1000,
				`Expected 1000 documents to fetch in < 1000ms, but took ${durationMs}ms`
			)
		})
	})
