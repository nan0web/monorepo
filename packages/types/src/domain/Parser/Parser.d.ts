...
export type ScanLinesCallback = (content: string, indent: number, lineNum: number, start: number, end: number, str: string, lines: string[]) => void;
/**
...
export default class Parser {
     ...
     */
    scanLines(text: string, callback: ScanLinesCallback): void;
    /**
