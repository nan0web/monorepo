 ...
 */
export function createInput(stops?: string[], predef?: string | undefined, console?: any, loop?: (input: Input) => Promise<boolean> | boolean): (question: string | {
    message: string;
 ...
 * @returns {Promise<any>}
 */
export function ask(target: string | Intent | Model | Function | Promise<any>, options?: any): Promise<any>;
/**
