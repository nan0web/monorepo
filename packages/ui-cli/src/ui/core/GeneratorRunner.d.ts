 ...
 */
export declare function runApp(AppEntryModel: typeof Object | Function, adapter: import('./InputAdapter.js').default, options?: any): Promise<void>;
/**
 ...
 * @param {Object} options
 */
export declare function runGenerator(model: import('@nan0web/ui').ModelAsApp, adapter: import('./InputAdapter.js').default, options?: any): Promise<{
    success: boolean;
    data: any;
    cancelled: boolean;
}>;
