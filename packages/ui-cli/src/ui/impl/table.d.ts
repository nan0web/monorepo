 ...
 * @param {string} [input.filterMsg] - Label for filter info.
 * @param {string} [input.noneMsg] - Label for empty filter value.
 * @param {string} [input.filterPrompt] - Message for the filter input prompt.
