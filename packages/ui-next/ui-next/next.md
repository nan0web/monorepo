...
> **Audit Date**: 7/19/2026, 8:01:12 PM
> **Health Score**: 43%

The following architectural issues were detected in @[{dir}].
...
- [ ] [phase] LICENSE: `Missing fundamental file: {file}`
...
- [ ] [phase] package.json: `package.json not found or invalid`
...
### JsHygieneAuditor
- [ ] [hygiene] scripts.test: `Missing required script: {script}`

  - **Suggested Fix**: `"test": "node --test"`

- [ ] [hygiene] scripts.test:all: `Missing required script: {script}`

  - **Suggested Fix**: `"test:all": "npm run build && npm run test && npm run knip"`

- [ ] [hygiene] scripts.build: `Missing required script: {script}`
...
- [ ] [hygiene] scripts.test:docs: `Missing required script: {script}`
...
- [ ] [hygiene] scripts.release:spec: `Missing required script: {script}`
- [ ] [hygiene] scripts.test:coverage: `Missing required script: {script}`
...
- [ ] [hygiene] tsconfig.json: `Missing config file: {file}`
