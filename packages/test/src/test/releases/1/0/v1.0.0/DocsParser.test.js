...
describe('DocsParser', () => {
	...
	it.skip('Each exported function must have installation examples', async () => {
	...
	it.skip('Usage examples should include both basic and advanced scenarios', async () => {
		const readmeContent = await fs.loadDocument('README.md')
	...
	it.skip('All code blocks should be executable and tested', async () => {
