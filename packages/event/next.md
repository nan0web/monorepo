...
> **Audit Date**: 5/15/2026, 2:36:32 PM
> **Health Score**: 43%

The following architectural issues were detected in @[@app/packages/event].
...
### JsDomainAuditor
- [ ] [domain] @app/packages/event/src/types/EventContext.js: `Class field outside constructor in @app/packages/event/src/types/EventContext.js (line 7)`
- [ ] [domain] @app/packages/event/src/types/EventContext.js: `Class field outside constructor in @app/packages/event/src/types/EventContext.js (line 10)`
- [ ] [domain] @app/packages/event/src/types/EventContext.js: `Class field outside constructor in @app/packages/event/src/types/EventContext.js (line 13)`
- [ ] [domain] @app/packages/event/src/types/EventContext.js: `Class field outside constructor in @app/packages/event/src/types/EventContext.js (line 16)`
- [ ] [domain] @app/packages/event/src/types/EventContext.js: `Class field outside constructor in @app/packages/event/src/types/EventContext.js (line 19)`
- [ ] [domain] @app/packages/event/src/types/EventContext.js: `Class field outside constructor in @app/packages/event/src/types/EventContext.js (line 22)`
