export class PyExportAuditor extends ExportAuditor {
     ...
     */
    checkPlatformExports(errors: import("../ExportAuditor.js").ExportError[], t: import("@nan0web/i18n").TFunction, fileExists: Function, dirExists: Function, readText: Function): AsyncGenerator<import("../../../../../ui/types/core/Intent.js").ShowIntent, void, unknown>;
}
