 ...
 */
export declare const INTENT_TYPES: readonly ['ask', 'progress', 'show', 'log', 'render', 'agent'];
/**
 * Detects if a value is a Model-as-Schema class (has static fields with `help`).
 * @param {*} schema
 * @returns {boolean}
 */
export declare function isModelSchema(schema: any): boolean;
/**
 ...
 */
export declare function validateIntent(intent: any): intent is Intent;
/**
 ...
 * @returns {AskIntent}
 */
export declare function ask(field: string, schema: object | Function, options?: object): AskIntent;
 ...
 */
export declare function progress(message: string, value?: number, optionsOrTotalOrId?: ProgressOptions | number | string, id?: string): ProgressIntent;
/**
 ...
 * @returns {LogIntent}
 */
export declare function log(level: LogLevel, message: string, data?: object): LogIntent;
/**
 ...
 */
export declare function render(component: string, props?: object): RenderIntent;
/**
 ...
 */
export declare function result(data: any, raw?: boolean): ResultIntent;
export type ShowData = {
    component?: any;
    model?: import('@nan0web/types').Model;
};
/**
 ...
 * @returns {ShowIntent}
 */
export declare function show(message: string | any, level?: ShowLevel | ShowData, data?: ShowData): ShowIntent;
/**
 ...
 * @returns {AgentIntent}
 */
export declare function agent(task: string, context?: AgentContext): AgentIntent;
