...
- **[Специфікація Моделей, Model-as-App та Інтенцій](./model-specification.md)** — як писати класи моделей, успадковувати `ModelAsApp`, налаштовувати `$ref` індекси (`index.{json|yaml|nan0|...}`) та генерувати інтенції.
...
- **[Автономні ШІ-Агенти та Контекст (AGENTS.md / llms.txt)](./agent-behaviors.md)** — поведінка агентів, взаємодія з RA-системою та стандартизація контексту для LLM.
