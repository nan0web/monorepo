...
export function getProvenDocs() {
	return (
		readFileSync(resolve(__dirname, '../../templates/provendocs.md'), { encoding: 'utf-8' }) || ''
	)
}
...
export function getTranslateDocs() {
	return (
		readFileSync(resolve(__dirname, '../../templates/translate-readme.md'), {
			encoding: 'utf-8',
		}) || ''
	)
}
...
export function getPlayground() {
	return (
		readFileSync(resolve(__dirname, '../../templates/playground.md'), { encoding: 'utf-8' }) || ''
	)
}
...
export function getSystem() {
	return readFileSync(resolve(__dirname, '../../templates/system.md'), { encoding: 'utf-8' }) || ''
}
